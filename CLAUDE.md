...
### Backend
- `backend/Dockerfile` — DONE (Railway-ready, Python 3.11 slim; uses uv for deps)
- `backend/pyproject.toml` — DONE (uv project; replaces requirements.txt)
- `backend/uv.lock` — DONE (generated by uv lock; commit this)
